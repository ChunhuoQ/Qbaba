...
package m03.d28.liupeng.dao.impl;

import java.util.ArrayList;
import java.util.List;

import m03.d28.liupeng.dao.BaseDao;
...
public class QuestionInfoDaoImpl extends BaseDao implements QuestionInfoDao {
    ...
    public List getAllInfo2(String like) {
        ...
        List<QuestionInfo> list = new ArrayList<QuestionInfo>();
        try {
            String sql = "SELECT q.`questionId`,q.`question`,q.`optionA`,q.`optionB`,q.`optionC`,q.`optionD`,q.`answer` FROM question_info q where question like ?";
            pst = getCon().prepareStatement(sql);
