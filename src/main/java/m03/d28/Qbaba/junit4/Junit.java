...
public class Junit {
    ...
    public static void main(String[] args) {
        ...
        if (out1 == 1) {
            List<QuestionInfoDaoImpl> list = qd.getAllQuestionInfoDaoImpl("SELECT * FROM question_info");
            for (QuestionInfoDaoImpl fo : list) {
        ...
        List<QuestionInfoDaoImpl> list1 = qd.getAllQuestionInfoDaoImpl(sql);
        for (QuestionInfoDaoImpl fo : list1) {
            System.out
                    .println(fo.getQuestionId() + "." + fo.getQuestion() + "\n" + fo.getOptionA() + "\n"
                            + fo.getOptionB() + "\n" + fo.getOptionC() + "\n" + fo.getOptionD() + "\n"
