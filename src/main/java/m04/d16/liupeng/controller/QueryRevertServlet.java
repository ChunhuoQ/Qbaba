...
/**
 * Servlet implementation class QueryRevertServlet
 */
public class QueryRevertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QueryRevertServlet() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Revert> listrev = bsi.getAllRevert(Integer.parseInt(id));
        List<Message> listm = bsi.getAllMessageById(Integer.parseInt(id));
