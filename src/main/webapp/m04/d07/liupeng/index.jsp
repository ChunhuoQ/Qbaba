<%@page import="m04.d07.liupeng.entity.CommentInfo"%>
...
<script type="text/javascript">
	function abc(){
		...
		window.location.href="result.jsp?uname="+uname+"&upwd="+upwd;//get的方式
	}
</script>
</head>
<body>
	<div id="header">
		...
		<!-- <form action="result.jsp" method="post"> -->
		  	<div id="top_login">
			    ...
			    <input type="button" class="login_sub" value="登录" onclick="abc();"/>
			    <label id="error"><%=session.getAttribute("error") %> </label>
    ...
    <div class="content">
      ...
      <ul class="classlist">
      	<%
			...
			for(int i=0;i<listCommentInfo.size();i++){
			    out.print("<li>"+"<a href='newspages/news_add.html'>"+ listCommentInfo.get(i).getContent()+" </a><span>" + listCommentInfo.get(i).getFbtime() +"</span></li>");
			}
    	%>
