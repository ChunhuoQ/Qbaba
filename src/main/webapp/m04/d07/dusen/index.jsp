...
<div id="header">
	<!-- <form action="result.jsp" method="get"> -->
		<div id="top_login">
			...
			<input type="submit" class="login_sub" value="登录" onclick="abc()" /> 
	...
	<div id="container">
		...
		<div class="main">
			...
			<div class="content">
				...
				bsi.setBizdao(bdi);
				List<CommentInfo> listt=bsi.all1();
				for(int i=0;i<listt.size();i++){
				    CommentInfo cif=listt.get(i);
				    out.print("<li><a href='newspages/news_add.html'>"+cif.getUsername()+"</a><span>"+cif.getFbtime()+"</span></li>");
				}
				%>
				<!-- 	<li><a href='newspages/news_add.html'> 深足教练组：说我们买球是侮辱
					...
					<li class='space'></li>
					<li><a href='#'> 人保部将首次就同工同酬做出规定 </a><span> 2009-10-28
							11:00:45.0 </span></li>
					<li><a href='#'> 重庆警方否认被围殴致死吸毒者曾针刺民众 </a><span>
							2009-10-28 11:00:25.0 </span></li>
					<li><a href='#'> 美国一名外交官辞职抗议美对阿富汗政策 </a><span>
							2009-10-28 11:00:02.0 </span></li>
					<li><a href='#'> 埃及交通部长因致18死火车相撞事故辞职 </a><span>
							2009-10-28 10:59:38.0 </span></li>
					<li><a href='#'> 无姚时代如何关注内线比拼 新赛季中锋PK五岳崛起 </a><span>
							2009-10-28 10:59:07.0 </span></li>
					<li class='space'></li>
					<li><a href='#'> 火箭揭幕战是试金石摸底测验 五号位二选一有玄机 </a><span>
							2009-10-28 10:58:36.0 </span></li>
					<li><a href='#'> 时过境迁火箭优势变劣势 对抗双塔阿帅只一计可施 </a><span>
							2009-10-28 10:58:11.0 </span></li>
					<li><a href='#'> 无姚新赛季落寞油然而生 周遭一种改变正悄悄开始 </a><span>
							2009-10-28 10:57:49.0 </span></li>
					<li><a href='#'> 美媒体称小布乃火箭新核心 一大缺陷令阿帅很担心 </a><span>
							2009-10-28 10:57:11.0 </span></li>
					<li><a href='#'> 皮特车祸之后仍然开朗 轻松改驾四轮车(图) </a><span>
							2009-10-28 10:56:43.0 </span></li>
					<li class='space'></li>
					<li><a href='#'> 8名美军士兵在阿富汗遭路边炸弹袭击身亡 </a><span>
							2009-10-28 10:55:38.0 </span></li>
					<li><a href='#'> 与基地有关组织宣称对巴格达连环爆炸负责 </a><span>
							2009-10-28 10:55:14.0 </span></li>
					<li><a href='#'> 伊朗将于30日前就核燃料供应方案作出答复 </a><span>
							2009-10-28 10:54:54.0 </span></li> -->
					<p align="right">
						当前页数:[1/2]&nbsp; <a href="#">下一页</a> <a href="#">末页</a>
					</p>
				</ul>
			</div>
			<div class="picnews">
