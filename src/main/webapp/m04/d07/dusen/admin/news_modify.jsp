...
<body>
	...
	<div id="admin_bar">
		<div id="status">
			管理员： 登录 &#160;&#160;&#160;&#160; <a href="index.html">login
				out</a>
		</div>
		<div id="channel"></div>
	</div>
	<div id="main">
		...
		<div id="opt_area">
			...
			<form action="xiutijiao.jsp" method="get" enctype="multipart/form-data"
				...
				<p>
					<label> 标题
						...
						class="opt_input" value="<%=session.getAttribute("title") %>" />
				</p>
				<p>
					<label> 作者 </label> <input name="nauthor" type="text"
						class="opt_input" value="<%=session.getAttribute("author ol;*") %>" />
				</p>
				<p>
					<label> 摘要 </label>
