...
<div id="header">
	...
	<div id="main">
		...
		<div id="opt_area">
			...
			bsi.setBizdao(bdi);
			List<NewsInfo> list=bsi.all();
			for(int i=0;i<list.size();i++){
			    NewsInfo nf=list.get(i);
			    out.print("<li>"+nf.getNewstitle()+"<span> 作者："+nf.getNewsauthor()+
		                "&#160;&#160;&#160;&#160; <a href='xiu.jsp?author="+nf.getNewsauthor()+"&title="+nf.getNewstitle()+"&sid="+nf.getNewsid()+"'>修改</a>&#160;&#160;&#160;&#160; "+
			...
			%>
				...
				<li>气候变化导致海平面上升 <span> 作者：news &#160;&#160;&#160;&#160;
						<a href='news_modify.html'>修改</a> &#160;&#160;&#160;&#160; <a
						href='#' onclick='return clickdel()'>删除</a>
				</span>
				</li>
