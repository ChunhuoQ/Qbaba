	...
	<div id="itemContainer">
		<c:if test="${not empty listpage}">
			<c:forEach items="${listpage}" var="p">
				<tr>
					<td>
						<div width="595" border="0" cellspacing="0" cellpadding="0">
						  <tr height="10">
						  	<td colspan="2">&nbsp;</td>
						  </tr>
						  <tr>
		 ...
		 <tr>
			<td>
			<div align="center">
			<%-- <a href="<%=path %>/spa?currentpage=${ pg.currentpage-1 }" target="_parent" style="text-decoration:none; color:#999999; font-size:13px;">上一页</a> 
			<span style="font-size:13px; color: #999999;">|</span> 
			<a href="<%=path %>/spa?currentpage=${ pg.currentpage+1 }" target="_parent" style="text-decoration:none; color:#999999; font-size:13px;">下一页</a> --%>
			</div>
			</td>
			<td>&nbsp;
			</td>
