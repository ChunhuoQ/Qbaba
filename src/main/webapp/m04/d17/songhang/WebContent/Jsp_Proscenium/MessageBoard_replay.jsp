...
<body background="Img_Background/1/bookbg.gif">
	<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
	  <tr>
	    <td height="25" colspan="4"><span class="title">主题: ${listmess.mid }</span></td>
	  </tr>
	  <tr>
	    ...
	    <td colspan="4"><table width="750" height="148" border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        <td><table width="750" height="54" border="0" cellpadding="0" cellspacing="0">
	          <tr>
	            <td height="22" background="Img_Background/1/title.gif" class="ltr"><font style="font-size: 12px; font-weight: bold;">&nbsp;&nbsp;※&nbsp;&nbsp;${listmess.mtitle }</font></td>
	          </tr>
	          <tr>
	            <td height="20" class="lr" ><p class="content">&nbsp;${listmess.mcontent }</p></td>
	          </tr>
	          <tr>
	            <td height="100" class="lrb">&nbsp;</td>
	          </tr>
	          <tr>
	            <td height="20" class="lrb"><span class="gray">&nbsp;${listmess.mname }&nbsp;写于&nbsp;${listmess.mdate }</span></td>
	          </tr>
	        </table></td>
	      </tr>
	    </table></td>
	  ...
	  <tr>
	    <td height="18" colspan="4"><table width="750" border="0" cellspacing="0" cellpadding="0">
	      ...
	      <c:if test="${not empty listpev}">
	      <c:forEach items="${listpev}" var="re">
	      <tr>
	  ...
	  <%-- <c:forEach items="loginName" var="rs"> --%>
	  <c:if test="${loginName==1 }">
	  <tr>
