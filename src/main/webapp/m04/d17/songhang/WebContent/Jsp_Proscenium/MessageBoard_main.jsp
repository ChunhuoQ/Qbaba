  ...
  <body background="Img_Background/1/bookbg.gif">
    <table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="top:0;">
	  <tr>
	    ...
	    <td width="45" background="Img_Background/1/titlemu_2.gif"><div align="center" class="newMessage" style="margin-top:4px;"><a href="Jsp_Proscenium/MessageBoard_replay.jsp">新留言</a></div></td>
	      ...
	      <tr>
	        ...
	        <table width="750" border="0" cellspacing="0" cellpadding="0" style="font-size:12px;">
			 ...
			 <c:if test="${not empty listMess}">
			  	<c:forEach items="${listMess}" var="m">
	           	  <tr>
		            <td class="lb"><div align="center">${m.rcount }</div></td>
		            <td height="25" class="lb"><span class="gray">&nbsp;<img src="Img_Background/1/jd-to.gif" width="13" height="13" border="0" />&nbsp;<a href="<%=path %>/Revert?id=${m.mid }" target="_parent">${m.mtitle }</a></span></td>
