<%@page import="m04.d17.songhang.entity.News"%>
	  ...
	  <tr height="35">
		...
		<td rowspan="16">
		 ...
		 <c:if test="${not empty listnews}">
			...
			<%-- <%
			List<News> list=(List<News>)session.getAttribute("listnews");
			for(int i=0;i<list.size();i++){
			    out.print("<tr><td height='22'>&nbsp;<a target='_parent' href='#'>"+list.get(i).getNtite()+" &nbsp;&nbsp;&nbsp;<span style='color: red;'>["+list.get(i).getNdate()+"]</span></a></td></tr>");
			}
			...
			%> --%>
				...
				<tr>
					<td height="22">&nbsp;<a target="_parent" href="News?id=${n.nid }">${n.ntite }&nbsp;&nbsp;&nbsp;<span style="color: red;">[${n.ndate}]</span></a></td>
				</tr>
			  	<tr>
