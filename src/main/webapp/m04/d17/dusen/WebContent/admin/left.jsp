...
<body topmargin="0" leftmargin="2" rightmargin="2" bottommargin="2"
	...
	<div id="masterdiv">
		<table border="0" width="158" id="table1" cellpadding="4"
			...
			<tr>
				<td><font color="#FFFFFF"><b>系统后台管理面板</b> </font></td>
			</tr>
			<tr>
				<td>
					<p align="center">
						<font color="#FFFFFF">[<a target="_parent"
							...
							target="_parent" href="../one.jsp"><font color="#FFFFFF">返回首页</font>
						</a>]
						</font>
				</td>
			</tr>
			...
			<TABLE cellSpacing="0" cellPadding="0" width="158"background="images/menu_2.gif" border="0">
				<TR>
					<TD height=25 width="100%" align="center" bgcolor="#D6E0EF"><img
						...
						<a class="menu" target="main" href="addNews.jsp">添加新闻</a></TD>
				</TR>
				<TR>
					<TD height=25 width="100%" align="center" bgcolor="#D6E0EF"><img
						border="0" src="../image/icon_arrow_r.gif" width="13" height="13">
						<a class="menu" target="main" href="#">管理新闻</a></TD>
				</TR>
			</table>
		</span>
		...
		<span class="submenu" id="sub3">
			<TABLE cellSpacing="0" cellPadding="0" width="158"background="images/menu_2.gif" border="0">
				<TR>
					<TD height=25 width="100%" align="center" bgcolor="#D6E0EF"><img
						border="0" src="../image/icon_arrow_r.gif" width="13" height="13">
						<a class="menu" target="main" href="addProduct.jsp">添加商品</a></TD>
				</TR>
				<TR>
					<TD height=25 width="100%" align="center" bgcolor="#D6E0EF"><img
						border="0" src="../image/icon_arrow_r.gif" width="13" height="13">
						<a class="menu" target="main" href="#">管理商品</a></TD>
				</TR>
			</table>
		</span>
