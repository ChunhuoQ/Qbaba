...
<body>
	<table width="179" height="632" border="0" cellpadding="0"
		cellspacing="0" class="border">
		<tr>
			<td height="42"><a href="Jsp_Proscenium/M_ShowProduct.jsp"
				target="_parent""><img src="Img_Proscenium/d_r11_6.jpg"
					width="179" height="42" border="0" /></a></td>
		</tr>
