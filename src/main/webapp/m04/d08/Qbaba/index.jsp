	...
	<div id="container">
		...
		<div class="main">
			...
			<div class="content">
				...
				<ul class="classlist">
					<%
					List<NewsCommentInfo> listc=(List<NewsCommentInfo>)session.getAttribute("listc");
					for(int o=0;o<listc.size();o++){
					    out.print("<li><a>"+listc.get(o).getCotent()+"</a><span>"+listc.get(o).getFbtime()+"</span></li>");
					}
					%>
