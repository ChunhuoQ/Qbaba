...
<div id="main">
  ...
  <div id="opt_area">
    ...
    List<NewsInfo> list=(List<NewsInfo>)request.getAttribute("listpage");
    //BizDaoImpl bdi = new BizDaoImpl();
    //int o=bdi.getsum();
    for(int i=0;i<list.size();i++){
        NewsInfo fo= list.get(i);
        out.print("<li>"+fo.getNewsTitle()+"<span>"+fo.getNewsAuthor()+
                "&#160;&#160;&#160;&#160; <a href='admin/News_modify.jsp?nid="+fo.getNewsId()+"&ntitle="+fo.getNewsTitle()+"&nauthor="+fo.getNewsAuthor()+
				"&nsummary="+fo.getNewsSummary()+"&ncontent="+fo.getNewsContent()+"'>修改</a>&#160;&#160;&#160;&#160; <a href='#' onclick='return clickdel()'>删除</a></span></li>");
    }
    %>
      ...
      <a href="spage.jsp?currentpage=<%=pg.getCurrentpage()==last1?pg.getCurrentpage():pg.getCurrentpage()+1 %>">下一页</a> 
      <a href="spage.jsp?currentpage=<%=last1%>">末页</a> </p>
    </ul>
  </div>
</div>
