<%@page import="m04.d04.liupeng.entity.NewsInfo"%>
<%@page import="java.util.List"%>
<%@page import="m04.d04.liupeng.service.impl.BizServiceImpl"%>
<%@page import="m04.d04.liupeng.dao.impl.BizDaoImpl"%>
...
<div id="admin_bar">
  <div id="status">
  	...
  	登录  &#160;&#160;&#160;&#160; <a href="index.html">login out</a>
  </div>
  <div id="channel"> </div>
</div>
<div id="main">
    ...
    <ul class="classlist">
    	<%
			...
			for(int i=0;i<listnews.size();i++){
			    out.print("<li>"+listnews.get(i).getNews_title()+"<span>作者:"+listnews.get(i).getNews_author()+"&#160;&#160;&#160;&#160; <a href='news_modify.html'>修改</a> &#160;&#160;&#160;&#160; <a href='#' onclick='return clickdel()'>删除</a>"+"</span></li>");
			}
    	%>
