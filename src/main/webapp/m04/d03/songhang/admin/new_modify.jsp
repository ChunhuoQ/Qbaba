...
<div id="main">
  ...
  <div id="opt_area">
    ...
    <form action="xiu1tijiao.jsp" method="post" enctype="multipart/form-data" onsubmit="return check()">
      <p>
        <label> 主题 </label>
        <select name="ntid">
      ...
      <p>
        <label> 作者 </label>
        <input name="nauthor" type="text" class="opt_input" value="<%=session.getAttribute("author ol;*") %>" />
      </p>
      <p>
        <label> 摘要 </label>
