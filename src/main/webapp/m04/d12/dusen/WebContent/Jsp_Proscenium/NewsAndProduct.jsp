...
<%@page import="m04.d12.dusen.com.entity.News"%>
	...
	<table align="center" width="620" height="230" border="0" cellpadding="0" cellspacing="0">
	  <tr height="35">
		...
		<%-- <c:if test="${not empty newsList}">
			...
			<% List<News>  listn=(List<News>)session.getAttribute("listn"); 
			for(int i=0;i<listn.size();i++){
			    out.print("<tr><td height='22'>&nbsp;<a target='_parent' href='#'>"+listn.get(i).getNtitle()+"&nbsp;&nbsp;&nbsp;<span style='color: red;'>["+listn.get(i).getNdate()+"]</span></a></td></tr>");
