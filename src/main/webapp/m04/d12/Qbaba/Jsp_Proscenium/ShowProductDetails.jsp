...
<html>
  ...
  <body>
	<table>
		...
		<tr>
			<td><div align="right"><a href="../../../../page?currentpage=${currentpage-1}"  target="_parent" style="text-decoration:none; color:#999999; font-size:13px;">上一页</a> <span style="font-size:13px; color: #999999;">|</span> <a href="../../../../page?currentpage=${currentpage+1}" target="_parent" style="text-decoration:none; color:#999999; font-size:13px;">下一页</a></div></td>
