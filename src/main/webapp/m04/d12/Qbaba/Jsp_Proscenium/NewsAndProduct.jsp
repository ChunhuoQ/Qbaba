...
<%@page import="m04.d12.Qbaba.entity.News"%>
	...
	<%--  ${listnews.nid} --%> 
		...
		<%-- 	<%
				...
				for(int i=0;i<listnews.size();i++){
					out.print("<tr><td height='22'>&nbsp;<a target='parent' href='#'>"+listnews.get(i).getNtitle()+"&nbsp;&nbsp;&nbsp;<span style='color: red;'>["+listnews.get(i).getNdate()+"]</span></a></td></tr>");
				}
			 %> --%>
