...
<body background="Img_Background/1/bookbg.gif">
	...
	<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
	   <c:if test="${not empty listm}">
	      <c:forEach items="${listm}" var="lis"> 
	  <tr>
	    <td height="25" colspan="4"><span class="title">主题: ${lis.mtitle }</span></td>
	  </tr>
	 </c:forEach>
	      </c:if> 
	  <tr>
	    ...
	    <td colspan="4"><table width="750" height="148" border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        <td><table width="750" height="54" border="0" cellpadding="0" cellspacing="0">
	          ...
	          <tr>
	            <td height="20" class="lr" ><p class="content">&nbsp;${lis.mcontent }</p></td>
	          </tr>
	          <tr>
	            <td height="100" class="lrb">&nbsp;</td>
	          </tr>
	          <tr>
	            <td height="20" class="lrb"><span class="gray">&nbsp;${lis.mname }&nbsp;写于&nbsp;${lis.mdate }</span></td>
	          </tr>
	        </table></td>
	      </tr>
	    </table></td>
