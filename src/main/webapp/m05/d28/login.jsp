...
<html>
  <head>
	...
	-->
	<link href="<%=basePath%>m05/d28/css/common.css" rel="stylesheet" type="text/css" />
	<link href="<%=basePath%>m05/d28/css/style.css" rel="stylesheet" type="text/css" />
...
<!-- main begin-->
 <div class="main">
   <div class="sidebar">
     <p><img src="<%=basePath%>m05/d28/images/img1.jpg" width="443" height="314" alt="" /></p>
   </div>
   <div class="sidebarg">
     <form action="doLogin.shtml" method="post">
    <div class="login">
      <dl>
        <dt class="blues">用户登陆</dt>
        <dd><label for="name">用户名：</label>
        	<input type="text" name="username" class="inputh" value="" id="name"/></dd>
        <dd><label for="password">密 码：</label>
        	<input type="password" name="userpassword" class="inputh" value="" id="password"/></dd>
        <dd>
           <label class="lf" for="passwords">验证码：</label>
           <input type="text" name="inputCode" class="inputh inputs lf" value="" id="passwords"/>
           <span class="wordp lf"><img id="validateCode" src="<%=basePath%>m05/d28/Number.jsp" width="96" height="27" alt="" /></span>
